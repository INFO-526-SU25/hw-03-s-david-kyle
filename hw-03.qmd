...
Students who received the flu vaccine gave more favorable responses to the survey’s trust-related statements. Excluding statements one and four, they also showed noticeably less variance in their responses. This supports the idea that individuals who receive vaccines tend to have a general trust in vaccines and the approval process—whether or not they fully understand the details of that process.
